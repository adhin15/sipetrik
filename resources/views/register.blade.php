...
<div class="row">
  <div class="col-sm">
    <label>Kecamatan</label>
     {!! Form::select('id_district',[''=>'--- Pilih Kabupaten/Kota ---'],null,['class'=>'form-control','required']) !!}
  </div>
  <div class="col-sm">
    <label>Kelurahan</label>
    {!! Form::select('id_villages',[''=>'--- Pilih Kabupaten/Kota ---'],null,['class'=>'form-control','required']) !!}
